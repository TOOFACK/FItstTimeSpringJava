...
import com.coursework.CourseWork.Models.Post;
import com.coursework.CourseWork.repo.PostRepository;
...
public class BlogController {
    ...
    public String blogPastAdd(@RequestParam String title, @RequestParam String anons, @RequestParam String text, Model model){
